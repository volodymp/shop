  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
				<a href="<?php echo $insert; ?>" data-toggle="tooltip" title="Добавить страницу фильтра" class="btn btn-primary"><i class="fa fa-plus"></i></a>
        <a href="<?php echo $cancel; ?>" data-toggle="tooltip" title="Вернуться к фильтрам" class="btn btn-warning"><i class="fa fa-reply"></i></a>
