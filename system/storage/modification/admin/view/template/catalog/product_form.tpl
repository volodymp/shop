          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
				...
				<label class="col-sm-2 control-label" for="input-price-zak"><?php echo $entry_price_zak; ?></label>
                <div class="col-sm-10" style="margin-bottom:10px;">
                <input type="text" name="price_zak" value="<?php echo $price_zak; ?>" id="input-price-zak" class="form-control" />
                </div>
