...
define('EXTENSION_VERSION',         '5.7.1');
...
define('EXTENSION_SUPPORT_FORUM',   'https://forum.opencart.com/viewtopic.php?f=123&t=45057');
...
class ControllerModuleAdminQuickEdit extends Controller {
	...
	private $column_defaults = array(
		'aqe_catalog_products'  => array(
			...
			'location'          => array('display' => 0, 'qe_status' => 0, 'editable' => 1, 'index' => 150, 'align' =>   'text-left', 'type' =>         'qe', 'sort' => 'p.location'      , 'rel' => array(),           'filter' => array('show' => 1, 'type' => 0, 'autocomplete' => array('return' => array('label' => 'location', 'value' => 'location')))),
		...
		'aqe_catalog_products_actions' => array(
			...
			'descriptions'      => array('display' => 0, 'index' =>  9, 'short' => 'desc',  'type' =>   'descr_qe', 'class' =>            '', 'rel' => array()),
	...
	private static $language_texts = array(
		...
		'help_filter_sub_category', 'help_columns', 'help_actions', 'help_highlight_actions',
		// Entries
		...
		'entry_marketing_coupons_status', 'entry_notify_customer', 'entry_highlight_actions',
		// Errors
