<?php
class ModelModuleOrdersetting extends Model {
	...
	public function getOrderStatusSendMail($order_id) {
		...
		if ($order_query->num_rows) {
			...
			$order_status_name = $this->db->query("SELECT * FROM `" . DB_PREFIX . "order_status` WHERE order_status_id = '" . (int)$order_query->row['order_status_id'] . "'");
			return array(
				'text_ttn'              => $order_query->row['text_ttn'],
	...
	public function getStatusSendOnOff($order_status_id) {
