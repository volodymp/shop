									...
									<div class="row">
										<div class="col-sm-12">
											<fieldset>
												...
												<div class="form-group">
													<label class="col-sm-3 col-md-2 control-label" for="aqe_highlight_actions0"><?php echo $entry_highlight_actions; ?></label>
													<div class="col-sm-9 col-md-10">
														<label class="radio-inline">
															<input type="radio" name="aqe_highlight_actions" id="aqe_highlight_actions1" value="1" data-bind="checked: highlight_actions"> <?php echo $text_yes; ?>
														</label>
														<label class="radio-inline">
															<input type="radio" name="aqe_highlight_actions" id="aqe_highlight_actions0" value="0" data-bind="checked: highlight_actions"> <?php echo $text_no; ?>
														</label>
													</div>
													<div class="col-sm-offset-3 col-md-offset-2 col-sm-9 col-md-10 help-container">
											...
											<div class="release">
												...
												<blockquote>
													...
													<ul>
														...
														<li>admin/language/*/catalog/aqe/product.php</li>
														<li>admin/language/*/module/admin_quick_edit.php</li>
											...
											<div class="release">
												...
												<blockquote>
													...
													<ul>
														...
														<li>admin/controller/module/admin_quick_edit.php</li>
														<li>admin/language/*/catalog/aqe/general.php</li>
														<li>admin/language/*/module/admin_quick_edit.php</li>
