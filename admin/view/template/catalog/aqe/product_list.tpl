									...
									<div class="input-group">
										...
										<div class="input-group-btn" data-toggle="buttons">
											...
											<ul class="dropdown-menu text-left pull-right price" role="menu">
												<li<?php echo (!in_array($filters['special_price'], array('active', 'expired', 'future', 'na'))) ? ' class="active"' : ''; ?>><a href="#" class="filter-special-price" data-value="" id="special-price-off"><i class="fa fa-fw<?php echo (!in_array($filters['special_price'], array('active', 'expired', 'future', 'na'))) ? ' fa-check' : ''; ?>"></i> <?php echo $text_special_off; ?></a></li>
												...
												<li<?php echo ($filters['special_price'] == 'na') ? ' class="active"' : ''; ?>><a href="#" class="filter-special-price" data-value="na"><i class="fa fa-fw<?php echo ($filters['special_price'] == 'na') ? ' fa-check' : ''; ?>"></i> <?php echo $text_special_not_available; ?></a></li>
											</ul>
										</div>
									</div>
								</th>
						...
						<tbody>
							...
							<tr>
								...
								<td class="<?php echo $column_info[$col]['align']; ?> action">
									...
									<?php } else { ?>
										<button type="button" class="btn <?php echo $action['data'] ? 'btn-warning' : 'btn-default'; ?> btn-xs action <?php echo $action['type']; ?> <?php echo $action['class']; ?>" id="<?php echo $action['action'] . "-" . $product['product_id']; ?>" data-toggle="tooltip" data-container="body" title="<?php echo $action['title']; ?>" data-column="<?php echo $action['action']; ?>"<?php echo ($action['rel']) ? ' data-rel="' . $action['rel'] . '"' : ''; ?>><?php if ($action['icon']) { ?><i class="fa fa-<?php echo $action['icon']; ?>"></i><?php } ?><?php echo $action['name']; ?></button>
									<?php } ?>
									<?php } ?>
									</div>
								</td>
