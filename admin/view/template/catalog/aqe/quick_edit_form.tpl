		...
		<div class="row">
			<div class="col-sm-12">
				<div class="well well-sm" style="height: 150px; overflow: auto;">
					...
					<div class="checkbox">
						<label>
							<input type="checkbox" name="i_s[]" value="<?php echo $store['store_id']; ?>"<?php echo (in_array($store['store_id'], $i_s)) ? ' checked="checked"' : ''; ?>/>
							<?php echo $store['name']; ?>
						</label>
					</div>
					<?php } ?>
		...
		<div class="row">
			<div class="col-sm-12">
				...
				<div id="item-filter" class="well well-sm" style="height: 150px; overflow: auto;">
					<?php foreach ($i_f as $item_filter) { ?>
					<div id="item-filter<?php echo $item_filter['filter_id']; ?>"><i class="fa fa-minus-circle" onclick="$(this).parent().remove();"></i> <?php echo $item_filter['name']; ?>
							<input type="hidden" name="i_f[]" value="<?php echo $item_filter['filter_id']; ?>" />
					</div>
					<?php } ?>
				</div>
			</div>
