  ...
  <div class="list-group" id="ocfilter-content">
      ...
      <div class="list-group-item selected-options">
        ...
        <div class="ocfilter-option">
          ...
          <button type="button" onclick="location = '<?php echo $value['href']; ?>';" class="btn btn-xs btn-primary" style="padding: 1px 4px;"><i class="fa fa-times"></i> <?php echo $value['name']; ?></button>
          <?php } ?>
        </div>
        <?php } ?>
				<?php $count = count($selecteds); $selected = $selecteds; $first = array_shift($selected); ?>
        <?php if ($count > 1 || count($first['values']) > 1) { ?>
        <button type="button" onclick="location = '<?php echo $link; ?>';" class="btn btn-block btn-primary" style="border-radius: 0;"><i class="fa fa-times-circle"></i> <?php echo $text_cancel_all; ?></button>
        <?php } ?>
      </div>
      <?php } ?>
